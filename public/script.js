...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function toggleStatus(button) {
    ...
    fetch(`https://tatoo-ink.onrender.com/api/turnos/${turnoId}`, {
      method: 'PUT',
      headers: {
 ...
 fetch('https://tatoo-ink.onrender.com/api/turnos')
      ...
      Object.keys(turnosPorDia).sort((a, b) => {
        ...
        turnosPorDia[dia].forEach(turno => {
          ...
          clientButton.addEventListener("click", function () {
            ...
            fetch(`https://tatoo-ink.onrender.com/clientes/${turnoId}`)
              .then(response => {
                ...
                if (cliente && (cliente.nombre || cliente.telefono || cliente.email)) {
                    ...
                    didOpen: () => {
                      ...
                      if (deleteButton) {
                        deleteButton.addEventListener('click', () => {
                          // Eliminar el cliente
                          fetch(`https://tatoo-ink.onrender.com/api/clientes/${turnoId}`, {
                            method: 'DELETE',
                          })
                            .then(response => response.json())
                            .then(data => {
                  ...
                  Swal.fire({
                    ...
                    preConfirm: () => {
                      ...
                      fetch(`https://tatoo-ink.onrender.com/clientes`, {
                        method: 'POST',
                        headers: {
                          'Content-Type': 'application/json',
                        },
